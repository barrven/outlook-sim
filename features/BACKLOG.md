...
|----|-------|--------|----------|------|
| 001 | App shell & classic Outlook layout | done | high | 001-app-shell.md |
...
| 014 | LLM client integration | done | high | 014-llm-client-integration.md |
...
| 065 | Mail — LLM-generated incoming attachments | done | high | 065-llm-generated-incoming-attachments.md |
...
| 056 | Tasks panel — unflag and pop-out controls on Flagged Mail rows | done | low | 056-tasks-panel-flagged-mail-controls.md |
| 057 | Tasks panel — Tasks section redesign (inline edit, header Add, due-date sort) | validating | low | 057-tasks-panel-redesign.md |
